  ...
  margin-top: 0px;
    ...
    <ul class="timeline">
        ...
        <li>
          ...
          <div class="timeline-panel">
            <div class="timeline-heading">
              <h4 class="timeline-title"><a href="https://www.ncbi.nlm.nih.gov/pubmed/27398999"  target="_blank" style="font-size:25px;">2016</a>  The pseudoknot fold facilitating sitespecific in-line cleavage[3]</h4>
            </div>
          </div>
        </li>
        <li class="timeline-inverted">
       ...
       <li class="timeline-inverted">
        ...
        <li class="timeline-inverted">
          ...
          <div class="timeline-panel">
            <div class="timeline-heading">
              <h4 class="timeline-title"><a href="https://www.ncbi.nlm.nih.gov/pubmed/35452066"  target="_blank" style="font-size:25px;">2022</a> new classical and combined quantum mechanical/molecular mechanical simulation of pistol ribozyme[13]</h4>
            </div>
          </div>
        </li>
    </ul>
    ...
    <div class="main-container">
        <div class="zoom-wrapper1">
            <div class="zoom-area1">
                <img src="http://127.0.0.1:4000/images/PistolPic/pistol2D.svg" alt="drawing"  style="height:140px" />
            </div>
        </div>
    </div>
...
<table><tr>
<td><img src="http://127.0.0.1:4000/images/PistolPic/pistol3D.png" alt="drawing" style="height:400px" border=0></td>
<td>
<html>
  <head>
    <meta charset="utf-8" />
...
<table><tr>
<td><img src="http://127.0.0.1:4000/images/PistolPic/pistol-m1.svg" alt="drawing" style="width:450px;height:300px" border=1 px></td>
<td><img src="http://127.0.0.1:4000/images/PistolPic/pistol-m2.png" alt="drawing" style="width:450px;height:360px" border=1 px></td>
</tr></table><br>
