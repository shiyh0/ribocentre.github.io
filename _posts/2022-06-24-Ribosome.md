...
Secondary structure diagram of the active site region. The P-loop is connected through a large region of domain V not included in these figures.
    ...
    <div class="main-container">
        <div class="zoom-wrapper1">
            <div class="zoom-area1">
                <img src="http://127.0.0.1:4000/images/RibosomePic/ribosome-PTC2D.svg" alt="drawing" style="width:180px;height:180px" />
            </div>
        </div>
    </div>
