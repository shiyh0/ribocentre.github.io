...
<font size=4>Ribonuclease mitochondrial RNA processing (RNase MRP) is a eukaryotic ribonucleoprotein (RNP) that is evolutionarily related to RNase P. RNase MRP processes precursor ribosomal RNA pre-rRNA by recognizing a short, loosely defined consensus sequence.</font><br>
    ...
    <div class="main-container">
        <div class="zoom-wrapper1">
            <div class="zoom-area1">
                <img src="https://www.ribocentre.org/images/RNasePPic/RNase P2D.svg" alt="drawing" style="width:135px;height:140px" />
            </div>
        </div>
    </div>
